...
public class BasicStringRowProcessor implements StringRowProcessor {
     ...
     *
     * @see com.lebao.common.dbhelp.dbutils.StringRowProcessor#toArray(java.sql.ResultSet)
     ...
     * @see com.lebao.common.dbhelp.dbutils.StringRowProcessor#toMap(java.sql.ResultSet)
