...
public class TimeUtil {
     ...
     * HH:mm:ss
     */
    public static final String TARGET_5 = "HH:mm:ss";
    /**
     * yyyy-MM-dd HH:mm
     */
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        String a = "2016-06-29 10:53:34";
        String b = format(a, TARGET_1, SOURCE_1);
        System.out.println(b);
        String c = TimeUtil.addDays(b, 5);
        System.out.println(c);
        String d = format(c, SOURCE_1, TARGET_1);
        System.out.println(d);
        //System.out.println(compareTime(format(TARGET_1,SOURCE_1,"2016-06-29 10:53:34"),format(TARGET_1,SOURCE_1,"2016-06-29 10:53:34")));
