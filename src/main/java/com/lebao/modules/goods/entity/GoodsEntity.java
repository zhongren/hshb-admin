package com.lebao.modules.goods.entity;
...
public class GoodsEntity {
    ...
    private String p_server;//varchar(20) NULL 商品名称
    private String p_photo1;//varchar(20) NULL 小图片名称
    private String p_photo2;//varchar(20) NULL 大图片名称
    private Float p_price;//float(15,2) NOT NULL 充值单价
    ...
    private String p_state;//tinyint(1) NOT NULL 状态
