...
public class NewsTypeController extends BaseController {
    ...
    public ModelAndView index() {
        ...
        view.addObject("title", "文章管理>>类型查询");
    ...
    public String queryAll() {
        try {
            List<NewsTypeVo> list = newsTypeService.queryAll();
            return this.buildMessage(ResultModal.SUCCESS, ResultModal.SUCCESS_CODE, "所有类型获取成功", list,
                    ResultModal.DATA);
        } catch (Exception e) {
