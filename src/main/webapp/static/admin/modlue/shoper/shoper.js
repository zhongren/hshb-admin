$(document)
    .ready(
        function () {
            setting.sAjaxSource = G_CTX_ROOT + "/shoper/query";
            setting.aoColumns = [
                {
                    "sTitle": "<center>商家名称</center>", //显示标题
                    "mData": "name", //属性
                    "bSortable": false,//排序
                    "sClass": "center",
                    "sWidth": "3%"
                ...
                {
                    "sTitle": "<center>电话号码</center>", //显示标题
                    "mData": "phone", //属性
                    "bSortable": false,//排序
                    "sClass": "center",
                    "sWidth": "3%"
                ...
                },
                {
                    ...
                    "mRender": function (data, style, obj) {
                        //console.log(obj);
                        var xqDom = "<a class=\"btn btn-round btn-info btn-xs\" href=\"/shoper/preUpdate/" + obj.id + "\" >查看详情</a>";
...
function delFj(id){
    ...
    $.ajaxInvoke({
        url		   : 	G_CTX_ROOT+"/upload/delFj/shoper",
        type	   : 	"post",
        data	   :	{
            "fileUrl"	: fileUrl
        },
