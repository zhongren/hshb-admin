                ...
                <div class="panel-body">
                    <div class="form-inline" >
                        <div class="form-group">
                            ...
                            <input name="s_name" type="text" class="form-control" id="name" placeholder="请输入类型">
                        </div>
                        <div class="form-group" style="padding-top: 22px;padding-left: 2px">
                            <button onclick="doSearch()" class="btn btn-primary">查询</button>
                        </div>
                        <div class="form-group pull-right" style="padding-top: 22px;"> <a class="btn btn-info" href="${ctx}/adv/preAdd" target="main">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">广告下架</h4>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel2">广告上架</h4>
            </div>
            <div class="modal-body">
                <div class="col-lg-12">
                    <section class="panel">
            ...
            <div class="modal-footer" >
                <button type="button" class="btn btn-default" data-dismiss="modal">否</button>
                <button id="reAdd" type="button" onclick="" class="btn btn-danger">是</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
