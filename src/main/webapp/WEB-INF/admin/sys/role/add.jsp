                ...
                <div class="panel-body">
                    <form role="form" >
                        <div class="form-group">
                            ...
                            <input type="text" id="roleName" placeholder="请输入权限角色名称" class="form-control">
                        </div>
                        <div class="form-group">
                            <font color="red">* </font>
                            <label for="roleDesc">备注信息：</label> <span></span>
                            <input type="text" id="roleDesc" placeholder="请输入备注信息" class="form-control" >
                        </div>
                        ...
                        <div >
                            ...
                            <div class="form-group">
                            <button class="btn btn-info" onclick="addPermission()">
