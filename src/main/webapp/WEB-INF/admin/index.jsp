            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown"><a data-toggle="dropdown"
                                        class="dropdown-toggle" href="#"> <img alt=""
                                                                               src="${ctx}/staticAdmin/img/avatar1_small.jpg"> <span
                        class="username">${sysUser.p_real_name}</span> <b class="caret"></b>
                </a>
                    <ul class="dropdown-menu extended logout">
                        <div class="log-arrow-up"></div>
                        <li><a href="javascript:void(0);">用户身份：${sysUser.p_role_name}</a></li>
                        <li><a href="javascript:void(0);">用户帐号：${sysUser.p_account}</a></li>
                        <li class="divider"></li>
