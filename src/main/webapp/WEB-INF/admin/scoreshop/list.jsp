            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-inline" >
                        ...
                        <div class="form-group pull-right" style="padding-top: 22px;"> <a class="btn btn-info" href="${ctx}/scoreshop/preAdd" target="main">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">商品下架</h4>
            </div>
