                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <input type="hidden" id="m_id" value="${ScoreShopBean.p_id}"/>
                           <!-- <input type="hidden" id="picUrlVal" value="${ScoreShopBean.p_photo1}"/>-->
                            <label for="m_name">商品名称：</label> <span></span>
                            <input type="text" id="m_name" placeholder="请输入商家名称" class="form-control" value="${ScoreShopBean.p_name}">
                        </div>

                        <div class="form-group">
                            <label for="m_type">属性：(虚拟/实物)</label> <span></span>
                            <input type="text" id="m_type" placeholder="请输入属性" class="form-control" value="${ScoreShopBean.p_type}">
                        </div>
                        <div class="form-group">
                            <label for="m_score">兑换所需积分：</label> <span></span>
                            <input type="text" id="m_score" placeholder="请输入积分" class="form-control"  value="${ScoreShopBean.p_score}">
                        </div>
                        <div class="form-group">
                            <label for="m_type">库存数</label> <span></span>
                            <input type="text" id="m_stock" placeholder="请输入库存" class="form-control" value="${ScoreShopBean.p_stock}">
                        </div>
                        <div class="form-group">

                            <label for="m_photo1" class="input input-file state-success">商品图片:</label><br>
                            <input type="hidden" id="m_photo1" value="${ScoreShopBean.p_photo1}"/>
                            <input type="button"  class="uploadPicture" name="m_photo1"  value="选择图片" />
                            <img src="${ScoreShopBean.p_photo1}" width="80" height="80">
                            <!--
                        ...
                        <div class="form-group">
                            <div class="pull-right">
                                ...
                                <button type="button" onclick="updScoreShop()" class="btn btn-primary">确认修改</button>
                            </div>
                        </div>
                    </form>
