                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <input type="text" id="m_name" placeholder="请输入商家名称" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="m_desc">描述：</label> <span></span>
                            <input type="text" id="m_desc" placeholder="请输入商家描述" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="m_phone" placeholder="请输入电话号码" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="m_keys">关键字：</label> <span></span>
                            <input type="text" id="m_keys" placeholder="请输入关键字" class="form-control">
                        </div>
                        <div class="form-group">
                            ...
                            <!--
                            <label for="picUrl" class="input input-file state-success">商家图片:(80*80)</label>
                        ...
                        <div class="form-group">
                            <div class="pull-right">
                                ...
                                <button type="button" onclick="addShoper()" class="btn btn-primary">确认添加</button>
                            </div>
                        </div>
                    </form>
