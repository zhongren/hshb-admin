            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-inline" >
                        ...
                        <div class="form-group pull-right" style="padding-top: 22px;"> <a class="btn btn-info" href="${ctx}/shoper/preAdd" target="main">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">商家删除</h4>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel2">商家上架</h4>
            </div>
            <div class="modal-body">
                <div class="col-lg-12">
                    <section class="panel">
