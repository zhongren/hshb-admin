                            ...
                            <div class="panel-body">
                                <form role="form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="m_phone" placeholder="请输入手机号码">
                                    </div>
                                    <div class="form-group">
                                        <label for="m_real_name">姓名：</label> <span></span>
                                        <input type="text" class="form-control" id="m_real_name" placeholder="请输入姓名">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="m_email" placeholder="请输入邮箱" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="m_role_id">权限角色：</label> <span></span><br>
                                        <select name="newsType" id="m_role_id" onChange="aab()"
                                            ...
                                            <c:forEach var="c" items="${roleList}">
                                                <option value="${c.p_id}">${c.p_name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <button type="button" onclick="addSysUser()" class="btn btn-primary">确认添加
                                        </button>
                                    </div>
                                </form>
                            </div>
