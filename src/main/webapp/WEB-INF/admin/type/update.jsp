                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <input type="hidden" id="m_id" value="${TypeBean.p_id}"/>
                            <label for="m_name">类型名称：</label> <span></span>
                            <input type="text" id="m_name" placeholder="请输入类型名称" class="form-control" value="${TypeBean.p_name}">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="pull-right">
                                ...
                                <button type="button" onclick="updType()" class="btn btn-primary">确认修改</button>
                            </div>
                        </div>
                    </form>
