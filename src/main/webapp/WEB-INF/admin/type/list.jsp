...
<head>
    ...
    <script src="${ctx}/staticAdmin/modlue/type/type.js"></script>
</head>
<body>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-inline" >
                        ...
                        <div class="form-group pull-right" style="padding-top: 22px;"> <a class="btn btn-info" href="${ctx}/type/preAdd" target="main">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel2">类型上架</h4>
            </div>
            <div class="modal-body">
                <div class="col-lg-12">
                    <section class="panel">
