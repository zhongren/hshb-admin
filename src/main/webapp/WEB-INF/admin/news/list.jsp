                ...
                <div class="panel-body">
                    <div class="form-inline" >
                        <div class="form-group">
                            ...
                            <input name="s_name" type="text" class="form-control" id="name" placeholder="请输入标题">
                        </div>
                        <div class="form-group" style="padding-top: 22px;padding-left: 2px">
                            <button onclick="doSearch()" class="btn btn-primary">查询</button>
                        </div>
                        <div class="form-group pull-right" style="padding-top: 22px;"> <a class="btn btn-info" href="${ctx}/news/preAdd" target="main">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">新闻删除</h4>
            </div>
